                ...
                <div className="col-auto mb-6">
                  <div className="footer-copyright">
                    <p className="copyright-text">
                      &copy; 2021 <a href="index.html">therankme</a>. Made with <i className="fa fa-heart text-danger"></i> by{" "}
                      <a href="https://therankme.com/" target="_blank" rel="noopener noreferrer">
                        therankme
                      </a>
                    </p>
                  </div>
