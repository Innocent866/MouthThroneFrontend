    ...
    It = (function (e) {
      ...
      return (
        ...
        (a._cleanTipClass = function () {
          var t = this.getTipElement(),
            e = t.getAttribute("className").match(Lt);
          null !== e &&
            e.length > 0 &&
            e
              .map(function (t) {
      ...
      _generateHTML: function (t) {
        ...
        for (
          ...
          for (_ = "", this.maxRows = 4, v = 0; v < F[1]; v++) {
            if (
              ((b = this._daylightSavingAdjust(new Date(K, q, t.selectedDay))),
              (x = " ui-corner-all"),
              (y = ""),
              L)
            ) {
  ...
  k.effects.define("blind", "hide", function (t, e) {
    ...
    k.effects.define("bounce", function (t, e) {
      ...
      for (
        ...
        ((i = {})[p] = (f ? "-=" : "+=") + l),
          ...
          (l = a ? 2 * l : l / 2);
      a &&
        (((i = { opacity: 0 })[p] = (f ? "-=" : "+=") + l), n.animate(i, u, d)),
        n.queue(e),
    ...
    k.effects.define("fold", "hide", function (e, t) {
      ...
      r && (a = (parseInt(r[1], 10) / 100) * f[o ? 0 : 1]),
        ...
        (p.clip[h[1]] = 0),
        n &&
          (i.cssClip(p.clip), c && c.css(k.effects.clipToBox(p)), (p.clip = u)),
        i
          .queue(function (t) {
            c &&
              c
